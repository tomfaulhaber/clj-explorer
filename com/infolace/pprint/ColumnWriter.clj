...
(ns com.infolace.pprint.ColumnWriter
  (:gen-class
...
(defn- get-field [#^com.infolace.pprint.ColumnWriter this sym]
  (sym @(.state this)))

(defn- set-field [#^com.infolace.pprint.ColumnWriter this sym new-val] 
...
(defn- -write 
  ([#^com.infolace.pprint.ColumnWriter this #^chars cbuf #^Integer off #^Integer len] 
     (let [#^java.io.Writer writer (get-field this :base)] 
       (.write writer cbuf off len)))
  ([#^com.infolace.pprint.ColumnWriter this x]
     (condp = (class x)
       String 
       (let [#^String s x
...
(defn- write-char [#^com.infolace.pprint.ColumnWriter this #^Integer c]
  (dosync (if (= c (int \newline))
	    (do
